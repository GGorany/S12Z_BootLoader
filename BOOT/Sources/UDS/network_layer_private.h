...
#define NT_XMIT_FC_STMIN            (0x02)       /* 0x00-0x7f, range:0ms-127ms */
#define NT_WFTmax                   (10)
...
#define NT_WFTmax                   (10)
#define TIMEOUT_N_CR                (1000)        /* 150 ms */
#define TIMEOUT_N_BS                (800)        /* 75 ms */
#endif
