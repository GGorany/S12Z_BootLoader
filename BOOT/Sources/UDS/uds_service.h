...
{
	UDS_SESSION_NONE =		0x00,
	UDS_SESSION_STD =		0x01,
	UDS_SESSION_PROG =		0x02,
...
typedef enum __UDS_RESET_T_
{
	UDS_RESET_NONE = 		0x00,
	UDS_RESET_HARD =		0x01,
	UDS_RESET_TO_APP = 		0x10,
	UDS_RESET_TO_BT =		0x20
}uds_reset_t;
...
*******************************************************************************/
extern bool dis_normal_xmit;
extern bool dis_normal_recv;
extern bool Flag_ECU_RESET;
